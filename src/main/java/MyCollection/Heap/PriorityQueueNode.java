...
public class PriorityQueueNode<T> implements Comparable<PriorityQueueNode> {
    ...
    /**
     * Creates a new PriorityQueueNode with specified data.
     *
    ...
    /**
     * Returns a string representation fot this node
     */
    ...
    /**
     * Returns 1 if the current node has higher priority than the given node and -1 otherwise
     *
     * @param obj the node do compare to this node
